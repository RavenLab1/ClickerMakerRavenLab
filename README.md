...
## آخر تحديث
تم ربط أشكال الكابات الجديدة بالأسماء الصحيحة:
- Cheese.glb للجبن
- keycap_strawberry.glb للفراولة
- keycap_Waffel.glb للوافل
- keycap_Chocolate.glb للشوكولاتة
- keycap_Noodles.glb للنودلز

تم أيضًا إضافة نسخ احتياطية للأسماء القديمة حتى لا يتعطل الموقع إذا بقيت خيارات قديمة في الكاش.
